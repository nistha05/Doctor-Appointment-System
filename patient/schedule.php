     ...
     <table class="menu-container" border="0">
        ...
        <?php
                ...
                $sqlmain= "SELECT * FROM schedule
                    ...
                    INNER JOIN priority ON schedule.pid = priority.id
                ...
                $searchtype="All";
                        ...
                        if(!empty($_POST["search"])){
                            ...
                            or specialties.sname like '%$keyword' 
                            or specialties.sname like '%$keyword%'  )  order by schedule.scheduledate asc";
                            //echo $sqlmain;
                            $insertkey=$keyword;
                    ...
                    <td >
                            <form action="" method="post" class="header-search">
                                        ...
                                        <?php
                                            ...
                                            $list13 = $database->query("select DISTINCT * from  specialties;");
                                        ...
                                        <td style="width: 25%;">
                                                <div  class="dashboard-items search-items"  >
                                                    ...
                                                    <div style="width:100%">
                                                            ...
                                                            <div class="h4-search">
                                                                <br>Starts: <b>'.substr($scheduletime,0,5).'</b> 
                                                            </div>
                                                            <div class="h4-search">
                                                                <br>Specialty: <b>'.substr($specialties,0,50).'</b> 
                                                            </div>
                                                            <div class="h4-search">
                                                                <br>Experience:<b>'.substr($experience,0,50).'</b> 
                                                            </div>
                                                            <div class="h4-search">
                                                                <br>Clinic:<b>'.substr($clinic,0,50).'</b> 
                                                            </div>
                                                            <br>

<?php
require_once 'recommendation.php'; // Include file if necessary
                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <form action="recommendation.php" method="post" style="display: flex">

                                <input type="search" name="search" class="input-text " placeholder="Find Doctors by Specialty" list="doctors" style="width:45%;">&nbsp;&nbsp;
